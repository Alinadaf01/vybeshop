...
import { buildProductJsonLd, absoluteUrl, DEFAULT_OG_IMAGE } from "@/lib/seo";
  ...
  return (
    <div>
      <Seo
        ...
        type="product"
        jsonLd={buildProductJsonLd(product, category?.name, absoluteUrl(product.images[0] ?? DEFAULT_OG_IMAGE))}
      />
