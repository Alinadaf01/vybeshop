...
// پیگیری سفارش واقعاً به حساب کاربری می‌رود (سفارش‌های کاربر آنجاست).
// سؤالات متداول هم صفحه اختصاصی خودش را دارد (src/pages/FaqPage.tsx).
// صفحه‌های سیاست ارسال/مرجوعی اختصاصی هنوز نداریم، پس به تماس با ما
// می‌روند تا لینک مرده نباشند.
